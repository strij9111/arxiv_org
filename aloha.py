"""
Здесь мы реализовали функцию aloha, которая принимает на вход вектор измерений y, длину аннигилирующего
фильтра L и количество ненулевых компонентов в спектре K.
Функция возвращает восстановленные компоненты спектра f_abs.
"""
import numpy as np
import cvxpy as cp
